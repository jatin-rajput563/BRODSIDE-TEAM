          ...
          <div className="bg-[#999999] px-5 py-10 md:pt-[78px] md:pb-[169px] md:pl-[63px] md:pr-[100px]">
            ...
            <div className="flex flex-wrap gap-5 justify-between mt-[60px]">
              <div className="min-[1272px]:max-w-[528px] w-full">
                ...
                <Description descriptionClass={"pt-[25px] ff-courir"} descriptionText={"1. All Broadsiders featuring existing cc0 artwork from other collections and artists are cc0. Meaning you  and anyone else can continue telling their story in any way you like, on any platform you wish"} />
              </div>
              <div className="min-[1272px]:max-w-[529px] w-full max-[1272px]:mt-6">
                ...
                <Description descriptionClass={"pt-[25px] md:pt-[45px] ff-courir"} descriptionText={"2. Broadsiders without cc0 traits grant the holder full commercial rights to that Broadsider’s name and likeness. Meaning you as the holder and only you as the holder have the ability to exploit your character commercially and continue telling their story in any way you like, on any platform you wish."} />
              </div>
            </div>
          </div>
        </div>
