      ...
      <div className="max-w-[1440px] mx-auto lg:pt-20 md:pt-14 pt-10">
        ...
        <div className="flex lg:mt-20.5 md:mt-14 mt-8 max-xl:flex-wrap">
          {JOURNEY_DATA.map((item, index) => (
            <div key={index} className="max-xl:mx-auto max-xl:mb-11">
              <img
                className="w-full pointer-events-none"
                src={item.img}
                alt="images"
              />
              <div className="mt-5 xl:mt-[50px] px-4">
                <p
                ...
                {index === 0 && (
                  <p className="text-2xl ff-courier leading-[120%] max-w-[338px] pt-3 xl:pt-[30px]">
                    {item.title}
                  </p>
                )}
                <p
                  className={` text-2xl ff-courier leading-[120%] pt-2.5 xl:pt-[30px] ${index === 2 ? "max-w-[415px]" : " max-w-[440px]"
                    }`}
                >
                  {item.description}
                </p>
