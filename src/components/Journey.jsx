          ...
          {JOURNEY_DATA.map((item, index) => (
            <div key={index} className="max-xl:mx-auto max-xl:mb-6">
              ...
              <div className="mt-5 md:mt-10 lg:mt-[50px] px-4">
                ...
                {index === 0 && (
                  <p className="text-2xl ff-courier leading-[120%] max-w-[338px] pt-2.5 md:pt-[30px]">
                    {item.title}
                  </p>
                )}
                <p
                  className={` text-2xl ff-courier leading-[120%] pt-2.5 md:pt-[30px] ${
                    index === 2 ? "max-w-[415px]" : " max-w-[440px]"
                  }`}
                >
                  {item.description}
                </p>
